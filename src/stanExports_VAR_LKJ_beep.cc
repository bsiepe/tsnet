...
#include "stanExports_VAR_LKJ_beep.h"

RCPP_MODULE(stan_fit4VAR_LKJ_beep_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_VAR_LKJ_beep")
