...
namespace model_VAR_LKJ_namespace {
...
static constexpr std::array<const char*, 78> locations_array__ =
  ...
  " (in 'string', line 28, column 2 to column 67)",
  " (in 'string', line 31, column 2 to line 32, column 68)",
  ...
  " (in 'string', line 37, column 4 to column 43)",
  ...
  " (in 'string', line 35, column 2 to line 47, column 3)",
  " (in 'string', line 84, column 11 to column 12)",
  " (in 'string', line 84, column 14 to column 15)",
  " (in 'string', line 84, column 4 to column 75)",
  " (in 'string', line 86, column 13 to column 14)",
  " (in 'string', line 86, column 6 to column 36)",
  " (in 'string', line 87, column 6 to column 73)",
  " (in 'string', line 85, column 17 to line 88, column 5)",
  " (in 'string', line 85, column 4 to line 88, column 5)",
  " (in 'string', line 82, column 2 to line 89, column 3)",
  " (in 'string', line 52, column 2 to column 50)",
  " (in 'string', line 57, column 2 to column 69)",
  " (in 'string', line 58, column 2 to column 49)",
  " (in 'string', line 65, column 8 to line 66, column 73)",
  " (in 'string', line 62, column 15 to line 67, column 9)",
  " (in 'string', line 62, column 6 to line 67, column 9)",
  " (in 'string', line 61, column 17 to line 68, column 7)",
  " (in 'string', line 61, column 4 to line 68, column 7)",
  " (in 'string', line 60, column 15 to line 69, column 5)",
  " (in 'string', line 60, column 2 to line 69, column 5)",
  " (in 'string', line 72, column 11 to column 12)",
  " (in 'string', line 72, column 14 to column 15)",
  " (in 'string', line 72, column 4 to column 75)",
  " (in 'string', line 74, column 13 to column 14)",
  " (in 'string', line 74, column 6 to column 36)",
  " (in 'string', line 75, column 6 to column 67)",
  " (in 'string', line 73, column 17 to line 76, column 5)",
  " (in 'string', line 73, column 4 to line 76, column 5)",
  ...
  " (in 'string', line 81, column 9 to column 12)"};
#include <stan_meta_header.hpp>
class model_VAR_LKJ final : public model_base_crtp<model_VAR_LKJ> {
private:
  int K;
  int T;
...
public:
  ~model_VAR_LKJ() {}
  model_VAR_LKJ(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_VAR_LKJ_namespace::model_VAR_LKJ";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_VAR_LKJ_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_VAR_LKJ_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"Beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"L_Theta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"sigma_theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"Beta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Rho\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(log_lik_1dim__) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"Beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"L_Theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((K * (K - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"sigma_theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"Beta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Rho\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(log_lik_1dim__) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_VAR_LKJ_namespace::model_VAR_LKJ;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_VAR_LKJ_namespace::profiles__;
}
#endif
#endif
