...
#include "stanExports_VAR_wishart.h"

RCPP_MODULE(stan_fit4VAR_wishart_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_VAR_wishart")
