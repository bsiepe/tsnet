...
namespace model_test_namespace {
...
class model_test final : public model_base_crtp<model_test> {
private:
  int N;
...
public:
  ~model_test() {}
  model_test(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_test_namespace::model_test";
    // suppress unused var warning
    (void) function__;
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_test_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_test_namespace::model_test;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_test_namespace::profiles__;
}
#endif
#endif
