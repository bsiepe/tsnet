#' Plot compare_gvar
#'
#' This function is a plotting method for the class "compare_gvar". It generates a plot showing the density distributions of two variables along with their empirical values.
#'
...
#'
#' The function generates two density plots using ggplot2, one for the variable beta and another for the variable pcor. The density distributions are filled with different colors based on the corresponding models (mod_a and mod_b). The empirical values of beta and pcor are indicated by red vertical lines.
#'
#' @import ggplot2
#' @import ggokabeito
#' @import cowplot
